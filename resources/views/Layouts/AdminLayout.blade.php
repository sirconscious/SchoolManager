...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="#" class="flex ms-2 md:me-24"> 
            <div class="h-10 w-10 bg-[rgb(0_240_255)] text-indigo-950 rounded-md flex items-center justify-center mr-3" style="transform: none;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-atom h-6 w-6 text-dark-900"><circle cx="12" cy="12" r="1"></circle><path d="M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z"></path><path d="M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z"></path></svg></div>
                <h1 class="text-2xl font-display text-white tracking-wider">
  SCHOOL <span class="text-[rgb(0_240_255)]">ACADEMY</span>
</h1>
   </a>
        </div>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
           ...
           <li>
              ...
              {{-- <a href="{{route('admin.studentList')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"> --}}
               ...
               class="flex items-center p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                         {{ request()->routeIs('admin.studentList') || request()->routeIs('admin.dashbored') ? 'bg-gray-700 text-white dark:hover:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
           ...
           <li>
              {{-- <a href="{{route('admin.teacherList')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"> --}}
               ...
               class="flex items-center p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                         {{ request()->routeIs('admin.teacherList') || request()->routeIs('admin.addTeacher') ? 'bg-gray-700 text-white dark:hover:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
           ...
           <li>
              {{-- <a href="{{route('admin.addTeacher')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"> --}}
               <a href="{{ route('emploie.index') }}" 
               class="flex items-center p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                         {{ request()->routeIs('emploie.index') ? 'bg-gray-700 text-white dark:hover:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
        ...
        <li>
            <a href="{{ route('videos.gestion') }}" 
            class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                      {{ request()->routeIs('videos.gestion') ? 'bg-gray-700 text-white dark:hover:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
                      <i class="fa-solid fa-video"></i>
                <span class="flex-1 ms-3 whitespace-nowrap">Video Management</span>
           </a>
        </li>
           <li>
