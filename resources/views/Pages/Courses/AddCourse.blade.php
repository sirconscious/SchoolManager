...
<form class="max-w-sm mx-auto w-full" action="{{route('course.store')}}" enctype="multipart/form-data" method="POST">
   @csrf
    <div class="mb-5">
